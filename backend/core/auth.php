...
// Force every protected page to be re-fetched fresh from the server instead
// of being restored from the browser's back/forward cache (bfcache) or disk
// cache. Without this, hitting the Back button (or sometimes even a plain
// refresh on mobile browsers) can show an old snapshot of the page — e.g. a
// profile picture that was just uploaded, a message that was just sent, or
// a task/note/event a admin just added/edited can *look* like it "disappeared"
// even though it's safely saved in the database. These headers make sure the
// browser always asks the server for the latest version.
